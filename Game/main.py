...
for x in range(1, c.TURRET_LEVELS + 1):
  turret_sheet = pg.image.load(f'Game/assets/images/turrets/turret_{x}.png').convert_alpha()
...
upgrade_turret_image = pg.image.load('Game/assets/images/buttons/upgrade_turret.png').convert_alpha()
begin_image = pg.image.load('Game/assets/images/buttons/begin.png').convert_alpha()
restart_image = pg.image.load('Game/assets/images/buttons/restart.png').convert_alpha()
fast_forward_image = pg.image.load('Game/assets/images/buttons/fast_forward.png').convert_alpha()
#gui
heart_image = pg.image.load("Game/assets/images/gui/heart.png").convert_alpha()
coin_image = pg.image.load("Game/assets/images/gui/coin.png").convert_alpha()
logo_image = pg.image.load("Game/assets/images/gui/logo.png").convert_alpha()

#load sounds
shot_fx = pg.mixer.Sound('Game/assets/audio/shot.wav')
...
while run:
  ...
  if game_over == False:
    ...
    if selected_turret:
      #if a turret can be upgraded then show the upgrade level
